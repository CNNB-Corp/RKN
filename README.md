...
- Параметр `Advanced.HttpRequireAll` определяет логику проверки: `false` — достаточно успеха хотя бы по одному из включенных тестов, `true` — все типы проверок должны пройти.
